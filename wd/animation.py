...
if __name__ == '__main__':
    # Read the images
    fixed_image = sitk.ReadImage("./test/100307/T1mni.nii.gz", sitk.sitkFloat32)
    moving_image = sitk.ReadImage("./test/188347/T1mni.nii.gz", sitk.sitkFloat32)
    ...
    registration_method.AddCommand(sitk.sitkIterationEvent,
                                   lambda: save_plot(registration_method, fixed_image, moving_image, transform,
